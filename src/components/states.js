...
const projectsArr = [
    ...
    {name: "React", description: "A plain snd simple portfolio website built using React", readmeLink: "https://github.com/H0RSESH0E/dBaron/tree/main/d-baron#readme", deploymentLink: "", screenshots: [{small:["work-example-5.png"]},{large:["react-screenshot.png"]}]},
