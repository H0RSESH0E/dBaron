...
const projectsArr = [
    ...
    {name: "SQL", description: "A CLI interface gets straight into the substance of creating, reading and updating a multi-tabular database", readmeLink: "https://github.com/H0RSESH0E/workforce#readme", deploymentLink: "https://drive.google.com/file/d/1xLTrXp841GpudqlrOQ8RbDgcSpM5ohjL/view", screenshots: [{small:["work-example-7.png"]},{large:["workforce-screenshot.png"]}]}
]
